...
const classes = computed(() =>
    props.active
        ? "inline-flex items-center px-1 pt-1 border-b-2 border-green-400 dark:border-green-600 text-sm font-medium leading-5 text-zinc-900 dark:text-zinc-100 focus:outline-none focus:border-green-700 transition duration-150 ease-in-out"
